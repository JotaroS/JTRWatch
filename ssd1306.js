...
var OLED = function()
{
  ...
  var ssd1306_command = function(c) { 
    ...
    wire.writeBytes(control, [c], function(err) {});
  }
...
OLED.prototype.display = function() {
 ...
 // upgrade to 400KHz! I2C
  for (var i=0; i<(SSD1306.LCDWIDTH*SSD1306.LCDHEIGHT/8); i+=16) {
    wire.writeBytes(0x40,buffer.slice(i,i+16));// send a bunch of data in one xmission (128-bit chunks)
  }
}
...
OLED.prototype.nodelogo = function()
{
	for(var x in nodelogo)
	{
	 buffer[x] = nodelogo[x];
	}
}
